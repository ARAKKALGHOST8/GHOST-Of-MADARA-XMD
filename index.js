...
console.log('ghsot of madara CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *➺ ghsot of madara-MD ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ your name ✅*
...
//================ownerreact==============
if(senderNumber.includes("918301966072")){
if(isReact) return
m.react("👑")
}
if(senderNumber.includes("918301966072")){
...
//==========================public react===============//
// Auto React 
if (!isReact && senderNumber !== 918301966072) {
